<template>
  ...
  <div class="col-9">
    ...
    bittet ihn um die Besorgung von Büchern. Auch der Inhalt eigener Werke ist in Sophie von La
    Roches Briefen Thema. Es werden z. B. Gedankengänge erklärt, die Einfluss auf ihre Werke
    genommen haben, oder Einblicke in den Schaffensprozess gewährt.
    ...
    zu denen Johann Isaak von Gerning zu dieser Zeit in Weimar Kontakt hatte.
