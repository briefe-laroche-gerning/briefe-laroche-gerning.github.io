...
<xsl:stylesheet
  ...
  <!-- Nur Elemente innerhalb von <body> verarbeiten-->
  <xsl:template match="/">
    ...
    <div>
      <xsl:attribute name="class">
        <xsl:choose>
          ...
          <!-- Alle inneren div (Seiten der Briefe) -->
          <xsl:otherwise>
            page
          </xsl:otherwise>
        </xsl:choose>
  ...
  <!-- unterstrichen / doppelt unterstrichen -->
  ...
  <!-- Lateinische Schrift (sonst: Kurrentschrift) -->
  ...
  <!-- Hochgestellte Wörter/Buchstaben -->
  ...
  <!-- Person -->
  <!-- Hilfstemplate (Werte von ref zu array umwandeln) (Benötigt, da ref für Personen und Werke mehrere IDs enthalten kann) -->
  ...
  <xsl:template match="tei:persName">
    <span>
      ...
      <xsl:attribute name="data-keys">
        ...
        <!-- Wenn ref vorhanden ist: Tokenize (mehrere IDs) -->
        <xsl:choose>
          <xsl:when test="@ref">
            <xsl:call-template name="json-array">
