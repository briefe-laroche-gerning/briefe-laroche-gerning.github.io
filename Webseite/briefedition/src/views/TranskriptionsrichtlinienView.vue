<template>
  ...
  <div class="col-9">
    ...
    <p>
      ...
      Das zugehörige Github-Repository ist abrufbar unter folgendem <a href="https://github.com/briefe-laroche-gerning/briefe-laroche-gerning.github.io" target="_blank">Link</a>.<br>
